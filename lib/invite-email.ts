...
export function buildInviteEmail(opts: {
  ...
  <div style="max-width:520px;margin:0 auto;background:#ffffff;border-radius:8px;padding:32px 28px;color:#0D0D0E;">
    ...
    <a href="${h.url}" style="display:inline-block;background:#FF3A69;color:#ffffff;font-weight:600;font-size:14px;padding:11px 24px;border-radius:6px;text-decoration:none;margin:0 0 22px;">Accept invite &amp; sign in</a>
