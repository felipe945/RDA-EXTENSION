...
Rules:
- needs_reply=false ONLY for clear closers ("thanks!", "sounds good", "🙏", an emoji react-style sign-off) with nothing pending underneath, AND for pure channel chatter between other people that isn't aimed at Felipe. When uncertain, needs_reply=true — a false alarm costs Felipe a glance; a missed one costs a client.
